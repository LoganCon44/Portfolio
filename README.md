...
In the first part of this project I used a 10-year bullet bond with semi-annual coupon payments to determine DV01 using discounted cash flows. Then I used DV01 to calculate the modified durration and the modified duration to calculate the macaulay duration and convexity. I then used this to estimate the effect of 25 basis points changes. With next part of the project I considered a sequence of zero-coupon prices for bonds maturing in 1-5 years, I used these prices to calculate zero coupon yields, implied forward 1-year rates, and par coupons. 
